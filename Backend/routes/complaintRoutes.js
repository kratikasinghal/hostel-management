import { createComplaint,deleteComplaint,getForAdmin,getForResident, updateAdmin,updateResident } from "../Controllers/complaintControllers.js";
...
router.patch('/resident/update',protect,updateResident)
